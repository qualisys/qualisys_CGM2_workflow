...
3. Install pyCGM2:
    ...
    - Open command prompt at the local folder where pyCGM2 is cloned to and type `pip install -e .` (when using Anaconda open AnacondaPromt and make sure the pycgm2 environment is active `activate pycgm2`).
...
2. Open Windows command prompt and use 'cd' to go to [QTM project folder]\Templates\Scripts\src\CGM2
